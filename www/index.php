...
<main class='startseite'>
    ...
    <button style='margin-left:0%;float:left;margin-right:10px' onclick='execUebersetzungAnfrage()' id='ue_button'>Anfrage stellen für eine Übersetzung</button>
    <button onclick='execDolmetscherAnfrage()' id='do_button'>Anfrage stellen für einen Dolmetscher</button>
    <nav  id='variabler_body'>
    </nav>
