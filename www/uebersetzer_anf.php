...
if (!$conn) {
    ...
    //echo "Datenbank-Verbindung => sucess.";
    //Kundendaten
    $nn_id=$_GET["nn_id"];
    $vn_id=$_GET["vn_id"];
    $gb_id=$_GET["gb_id"];
    ...
    $email_id=$_GET["email_id"];  //Dieses Atribut existiert in der Datenbank bis jetzt nicht!!
    ...
    //: Füg der Kunden ein und seine Adress id,Speichere Kuden Id
